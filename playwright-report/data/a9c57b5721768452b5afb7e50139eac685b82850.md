...
- Name: 02-transactions.spec.ts >> Transactions — create / edit / delete / search / sort >> create a transaction with a comma decimal amount
- Location: tests/e2e/02-transactions.spec.ts:6:3
