...
- Name: 02-transactions.spec.ts >> Transactions — create / edit / delete / search / sort >> search filters and sort control is present
- Location: tests/e2e/02-transactions.spec.ts:58:3
