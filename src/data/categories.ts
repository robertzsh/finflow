...
export const DEFAULT_CATEGORIES: Category[] = [
  ...
  { id: 'delivery', name: 'Food delivery', kind: 'expense', icon: 'Bike', color: '#f97316', emoji: '🛵' },
  { id: 'wolt', name: 'Wolt', kind: 'expense', icon: 'Bike', color: '#06b6d4', emoji: '🛵', parent: 'delivery' },
  ...
  { id: 'dm', name: 'DM', kind: 'expense', icon: 'Sparkles', color: '#f43f5e', emoji: '🧴', parent: 'cosmetics' },
  { id: 'sephora', name: 'Sephora', kind: 'expense', icon: 'Sparkles', color: '#a855f7', emoji: '💄', parent: 'cosmetics' },
  { id: 'douglas', name: 'Douglas', kind: 'expense', icon: 'Sparkles', color: '#0ea5e9', emoji: '💄', parent: 'cosmetics' },
  { id: 'notino', name: 'Notino', kind: 'expense', icon: 'Sparkles', color: '#8b5cf6', emoji: '🧴', parent: 'cosmetics' },
